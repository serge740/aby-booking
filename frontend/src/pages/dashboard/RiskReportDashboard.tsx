          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <div>
                ...
                <p className="text-xs text-gray-500">Create, view and manage workplace risk reports</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <motion.button
        ...
        {loading ? (
          <div className="bg-white rounded-lg shadow border border-gray-100 p-8 text-center text-gray-600">
            <div className="inline-flex items-center space-x-2">
              ...
              <span className="text-xs">Loading risk reports...</span>
            </div>
          </div>
        ) : reports.length === 0 ? (
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
              ...
              <div className="flex items-center justify-end space-x-3">
                ...
                <motion.button whileHover={{ scale: 1.05 }} onClick={() => handleDeleteReport(deleteConfirm)} className="px-4 py-2 text-xs bg-red-600 text-white rounded hover:bg-red-700">
                  Delete
                </motion.button>
              </div>
            </div>
      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">Mark as resolved with optional note</p>
          </div>
        </div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-xl">
              ...
              <div className="flex items-center justify-end space-x-3">
                ...
                <motion.button whileHover={{ scale: 1.05 }} onClick={handleRejectReport} disabled={!rejectReason.trim()} className="px-4 py-2 text-xs bg-red-600 text-white rounded hover:bg-red-700 disabled:opacity-50">
                  Reject
                </motion.button>
              </div>
            </div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg p-6 w-full max-w-lg shadow-xl overflow-y-auto max-h-screen">
              ...
              <div className="flex items-center justify-end space-x-3">
                ...
                <motion.button whileHover={{ scale: 1.05 }} onClick={handleCreateOrUpdateReport} disabled={operationLoading} className="px-4 py-2 text-xs bg-primary-600 text-white rounded hover:bg-primary-700 disabled:opacity-50">
