    ...
    <div className="w-full flex flex-col pb-16 items-center gap-12 ">
      ...
      <div className="w-full px-4 lg:px-14 mx-auto -mt-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
          {contactInfo.map((info, index) => (
            <div
              key={index}
              className="group relative bg-white/90 rounded-2xl p-6 shadow-md hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-primary-600"
            >
              ...
              <div className="relative">
                <h3 className="text-sm font-semibold text-primary-600 uppercase tracking-wide mb-1">
                  {info.title}
                </h3>
                {info.link ? (
                  <a
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-8 lg:gap-12 w-full px-4 lg:px-14 mx-auto">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          <div className="relative bg-white/90 p-8 lg:p-10 rounded-2xl shadow-xl border border-primary-600">
            {/* Decorative gradient blobs */}
            <div className="absolute -top-2 -right-2 w-32 h-32 bg-gradient-to-br from-primary-600 to-primary-700 opacity-10 rounded-full blur-3xl"></div>
            <div className="absolute -bottom-2 -left-2 w-32 h-32 bg-gradient-to-br from-primary-600 to-primary-700 opacity-10 rounded-full blur-3xl"></div>
              ...
              <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-5">
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl border-2 border-primary-600 bg-primary-600/10 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-700 focus:bg-white transition duration-200"
                  />
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <textarea
                    ...
                    required
                    rows="5"
                    className="w-full px-4 py-3 rounded-xl border-2 border-primary-600 bg-primary-600/10 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-primary-700 focus:bg-white transition duration-200 resize-none"
                  ></textarea>
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="group relative w-full py-3.5 mt-2 bg-gradient-to-r from-primary-600 to-primary-700 text-white font-bold text-lg rounded-xl hover:from-primary-700 hover:to-[#8c7452] transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
                >
      ...
      <div className="w-full px-4 lg:px-14 mx-auto">
        <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-3xl p-8 lg:p-12 text-white shadow-2xl relative overflow-hidden">
