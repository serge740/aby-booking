          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-r from-primary-500 to-secondary-500 opacity-0 group-hover:opacity-5 rounded-2xl transition-opacity duration-300`}
                ></div>

                {/* Icon Container */}
                <div
                  className={`relative w-14 h-14 rounded-xl bg-gradient-to-r from-primary-500 to-secondary-500 flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                >
                ...
                {/* Decorative Element */}
                <div
                  className={`absolute -bottom-1 -right-1 w-20 h-20 bg-gradient-to-r from-primary-500 to-secondary-500 opacity-5 rounded-full blur-2xl group-hover:opacity-10 transition-opacity duration-300`}
                ></div>
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col lg:flex-row justify-center gap-8 lg:gap-12 w-full px-4 lg:px-14 mx-auto ">
            ...
            <div className="w-full h-[755px] lg:w-1/2 flex flex-col justify-center  ">
              <div className="relative bg-white/90  lg:p-12 rounded-2xl shadow-xl border border-primary-500 h-full ">
                ...
                <div className="absolute -top-2 -right-2 w-32 h-32 bg-gradient-to-br from-primary-500 to-secondary-500 opacity-10 rounded-full blur-3xl"></div>
                <div className="absolute -bottom-2 -left-2 w-32 h-32 bg-gradient-to-br from-primary-500 to-secondary-500 opacity-10 rounded-full blur-3xl"></div>
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-xl border-2 border-primary-500 bg-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#a38e6a] focus:bg-white transition duration-200"
                      />
                    </div>
                    ...
                    <div className="flex flex-col">
                      ...
                      <textarea
                        ...
                        required
                        rows="5"
                        className="w-full px-4 py-3 rounded-xl border-2 border-primary-500 bg-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#a38e6a] focus:bg-white transition duration-200 resize-none"
                      ></textarea>
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="group relative w-full py-3.5 mt-2 bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-bold text-lg rounded-xl hover:from-[#a38e6a] hover:to-[#8c7452] transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed overflow-hidden"
                    >
