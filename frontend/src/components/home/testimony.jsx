...
export default function AbyTestimonials() {
  const testimonials = [
    ...
    },
    {
      ...
      text: "ABY DASH never disappoints. Their pizza is authentic and delicious, and the delivery is always on time. This is my go-to place for weekend meals with friends.",
      rating: 5.0,
      align: "right",
    },
    {
