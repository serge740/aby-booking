...
const Header = ({title, path}) => {
    return (
        <div className='relative w-full h-[50vh] flex justify-center items-center overflow-hidden'>
            ...
            >
                {/* Gradient Overlays */}
                <div className='absolute inset-0 bg-gradient-to-r from-amber-900/40 via-amber-800/30 to-amber-700/25'></div>
                <div className='absolute inset-0 bg-gradient-to-b from-transparent via-amber-900/20 to-amber-950/40'></div>
            </div>

            {/* Content Container */}
            <div className="relative z-10 flex flex-col h-full justify-center items-center px-4">
                {/* Decorative Top Line */}
                <div className='w-24 h-1 bg-amber-500 mb-6 rounded-full'></div>
                ...
                <div className='flex items-center gap-2 text-sm sm:text-base'>
                    <span className='text-amber-100 hover:text-white transition-colors cursor-pointer font-medium'>
                        Home
                    </span>
